...
class TaskServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.UpdateTaskName = channel.unary_unary(
                '/task.TaskService/UpdateTaskName',
                request_serializer=task__pb2.UpdateTaskNameRequest.SerializeToString,
        ...
        self.UpdateTaskStatus = channel.unary_unary(
                ...
                request_serializer=task__pb2.UpdateTaskStatusRequest.SerializeToString,
                response_deserializer=task__pb2.TaskResponse.FromString,
                _registered_method=True)
        ...
        self.ListTasks = channel.unary_unary(
                ...
                request_serializer=task__pb2.ListTaskRequest.SerializeToString,
                response_deserializer=task__pb2.TaskResponse.FromString,
                _registered_method=True)
...
class TaskServiceServicer(object):
    ...
    def UpdateTaskName(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_TaskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UpdateTaskName': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateTaskName,
                    request_deserializer=task__pb2.UpdateTaskNameRequest.FromString,
            ...
            'UpdateTaskStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=task__pb2.UpdateTaskStatusRequest.FromString,
                    response_serializer=task__pb2.TaskResponse.SerializeToString,
            ),
            ...
            'ListTasks': grpc.unary_unary_rpc_method_handler(
                    servicer.ListTasks,
                    request_deserializer=task__pb2.ListTaskRequest.FromString,
                    response_serializer=task__pb2.TaskResponse.SerializeToString,
            ),
...
class TaskService(object):
    ...
    def UpdateTaskName(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/task.TaskService/UpdateTaskName',
            task__pb2.UpdateTaskNameRequest.SerializeToString,
    ...
    def UpdateTaskStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/task.TaskService/UpdateTaskStatus',
            task__pb2.UpdateTaskStatusRequest.SerializeToString,
            task__pb2.TaskResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def ListTasks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/task.TaskService/ListTasks',
            task__pb2.ListTaskRequest.SerializeToString,
            task__pb2.TaskResponse.FromString,
            options,
            channel_credentials,
            insecure,
